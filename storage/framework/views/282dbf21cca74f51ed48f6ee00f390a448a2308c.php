    ...
    <br/>
      ...
      <div class="col-md-12">
        <div class="panel panel-default">
          ...
          <?php echo Form::model($tag, array('action' => array('TagController@update', $tag->id), 'method' => 'PUT')); ?>
            ...
            <?php echo csrf_field(); ?>
              ...
              <div class="form-group has-feedback row <?php echo e($errors->has('name') ? ' has-error ' : ''); ?>">
                ...
                <div class="col-md-9">
                  <div class="input-group">
                    <?php echo Form::text('name', NULL, array('id' => 'name', 'class' => 'form-control', 'placeholder' => $tag->name )); ?>
              ...
              <div class="form-group has-feedback row <?php echo e($errors->has('slug') ? ' has-error ' : ''); ?>">
                ...
                <div class="col-md-9">
                  <div class="input-group">
                    <?php echo Form::text('slug', NULL, array('id' => 'slug', 'class' => 'form-control', 'placeholder' => $tag->slug )); ?>
              ...
              <?php echo Form::button('<i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;' . 'Edit tag', array('class' => 'btn btn-success btn-flat margin-bottom-1 pull-right','type' => 'submit', )); ?>
