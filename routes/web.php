...
Route::get('/giris', 'WelcomeController@giris')->name('blog');
...
Route::group(['middleware'=> ['auth', 'activated', 'currentUser']], function () {
    ...
    Route::get('like/{id}','LikeController@postLike');
    Route::get('unlike/{id}','LikeController@postUnlike');
...
Route::group(['middleware'=> ['auth', 'activated', 'role:admin']], function () {
    ...
    Route::get('blog','PostController@dash');
    ...
    Route::post('blog/comments',['uses'=>'CommentController@postComment']); 
