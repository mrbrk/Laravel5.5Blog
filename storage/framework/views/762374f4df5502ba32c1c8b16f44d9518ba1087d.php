  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo e(Lang::get('modals.confirm_modal_title_text')); ?> </h4>
      </div>
      <div class="modal-body">
        <p><?php echo e(Lang::get('modals.confirm_modal_title_text')); ?> </p>
      </div>
      <div class="modal-footer">
        ...
        <?php echo Form::button('<i class="fa fa-fw '.Lang::get('modals.confirm_modal_button_save_icon').'" aria-hidden="true"></i> ' . Lang::get('modals.confirm_modal_button_save_text'), array('class' => 'btn btn-success pull-right btn-flat', 'type' => 'button', 'id' => 'confirm' )); ?>
